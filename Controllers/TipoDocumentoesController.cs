...
namespace TP2024_Etapa4_26012_24200_18577.Controllers
{
    public class TipoDocumentoesController : Controller
    {
        ...
        public TipoDocumentoesController(AlojamentoEstudantilContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tipoDocumento = await _context.TipoDocumentos
                .FirstOrDefaultAsync(m => m.Tdid == id);
        ...
        public async Task<IActionResult> Create([Bind("Tdid,DescricaoDocumento")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Tdid,DescricaoDocumento")] TipoDocumento tipoDocumento)
        {
            if (id != tipoDocumento.Tdid)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TipoDocumentoExists(tipoDocumento.Tdid))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.TipoDocumentos.Any(e => e.Tdid == id);
        }
    }
}
